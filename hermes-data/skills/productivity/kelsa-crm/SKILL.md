...
| From Account Of | `cf_on_account_of` | `"Admin"` (string label) |
...
- **Dropdown fields** (`cf_request_type`, `cf_on_account_of`, `cf_account_to_be_debited`):
...
uid = canonical_uid("7449813913")  # ← replace with the user's telegram ID
...
telegram_id = "7449813913"  # use the actual user's telegram id
