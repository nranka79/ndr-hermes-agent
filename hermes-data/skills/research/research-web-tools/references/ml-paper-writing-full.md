...
**Absorbed:** research-paper-writing (2026-05-08)

**Reason:** Same class — both are ML/AI conference paper writing skills. ml-paper-writing is the established umbrella in the research/ directory; research-paper-writing was a parallel narrower sibling with overlap in templates, citation workflow, reviewer guidelines, and writing philosophy.

**Content absorbed:**
- `references/autoreason-methodology.md` — AutoReason chain-of-thought reasoning methodology for ML papers
- `references/experiment-patterns.md` — Common experimental patterns and ablations structure
- `references/human-evaluation.md` — Human evaluation protocols and metrics for NLP/ML papers
- `references/paper-types.md` — Taxonomy of paper types (theoretical, empirical, engineering)
- (other reference files were duplicates already present in ml-paper-writing; originals retained)

**Skill archived** — all content merged into ml-paper-writing.
