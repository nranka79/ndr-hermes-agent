...
Context for the daily cron job `not-spam-whitelist` (DRAAS, user ndr / 7449813913).
...
- Cron spec says: use `gws_token.json` at `/data/hermes/users/7449813913/gws_token.json`.
...
- Working access (verified):
  ...
  ```
- Session user id env: HERMES_SESSION_USER_ID=7449813913 → vault canonical id `ndr-7449813913` (Nishant Ranka, ndr@draas.com).
