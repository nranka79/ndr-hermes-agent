...
_HERMES_CORE_TOOLS = [
    ...
    # Cronjob management
    "cronjob",
    # Cross-platform messaging + employee directory (gated on gateway/n8n via check_fn)
    "send_message",
    "user_lookup_tool",
    ...
    "contact_resolver",
    # Fuzzy + phonetic search across all registry sheets (contacts/projects/entities/land/topics)
    "entity_resolver",
    # N8N workflow router for Sheets/Gmail/Drive/Calendar with traceability
    "n8n_tool",
    # PDF operations: extract pages, convert to images, combine images to PDF, read text
    "pdf_tool",
]
...
TOOLSETS = {
    ...
    "messaging": {
        "description": "Cross-platform messaging and employee directory: send messages, look up colleagues by name.",
        "tools": ["send_message", "user_lookup_tool"],
        "includes": []
    },
