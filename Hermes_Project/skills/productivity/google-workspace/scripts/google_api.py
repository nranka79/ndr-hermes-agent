...
def _gws_env() -> dict[str, str]:
    """Build subprocess env for gws CLI with the current session user's vault token."""
...
def build_service(api, version):
    from tools.gws_auth import build_service as _auth_build_service
    return _auth_build_service(api, version)
