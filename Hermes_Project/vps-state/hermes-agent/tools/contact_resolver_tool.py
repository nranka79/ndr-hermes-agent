...
def _handle_contact_resolver(args: dict, **_) -> str:
    ...
    account_email = (args.get("account_email") or "ndr@draas.com").strip()  # SA DWD subject; sheet is owned by ndr@draas.com
...
_SCHEMA = {
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "account_email": {
                "type": "string",
                "description": "SA DWD subject email. Defaults to ndr@draas.com (sheet owner).",
            },
        },
        "required": ["query"],
    },
