...
def sync_skills(quiet: bool = False) -> dict:
    ...
    force_skill = os.environ.get("HERMES_FORCE_SKILL_SYNC", "").strip()
    ...
    for skill_name, skill_src in bundled_skills:
        ...
        if skill_name not in manifest:
            ...
            if user_hash != origin_hash:
                ...
                # unless HERMES_FORCE_SKILL_SYNC targets this skill or "all"
                if force_skill and (force_skill == "all" or force_skill == skill_name):
                    pass  # fall through to update logic below
                else:
    ...
    # Clear force-sync env var now that the loop is done
    if force_skill:
        os.environ.pop("HERMES_FORCE_SKILL_SYNC", None)
