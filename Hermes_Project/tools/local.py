...
def _make_run_env(env: dict) -> dict:
    ...
    # subprocesses see the *current* request's identity, not whatever
    # stale value is sitting in os.environ from process startup or a
    # previous request.  The helper is the single source of truth for
    # this bridging; see
