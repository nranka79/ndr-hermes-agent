...
def execute_code(
    ...
    try:
        ...
        # Bridge the full session context into the sandbox child env so any
        # downstream tool the script invokes (gws_auth, gws_vault, kanban,
        # …) sees the *current* request's identity, not whatever stale
        # value is in os.environ.  The helper is the single source of
        # truth for this bridging; see
        ...
        try:
            ...
            inject_session_context_into_env(child_env)
        except Exception:
            pass
