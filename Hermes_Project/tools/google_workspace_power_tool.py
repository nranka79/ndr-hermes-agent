        ...
        "properties": {
            "command": {
                ...
                "description": (
                    ...
                    "  gmail messages send --to alice@example.com --subject \"Subject\" --body \"Body text\"\n"
                    "  gmail messages send --to alice@example.com --to bob@example.com --subject \"Subject\" --body \"Body\" --cc carol@example.com\n"
                    ...
                    "# CALENDAR\n"
                    "  calendar events list --calendarId primary --params '{\"maxResults\":20}'\n"
                    "  calendar events list --calendarId primary --params '{\"timeMin\":\"2026-04-10T00:00:00+05:30\",\"timeMax\":\"2026-04-10T23:59:59+05:30\",\"singleEvents\":true,\"orderBy\":\"startTime\",\"maxResults\":20}'\n"
